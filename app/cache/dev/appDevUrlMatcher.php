...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // comment_create
        if (0 === strpos($pathinfo, '/comment') && preg_match('#^/comment/(?P<film_id>\\d+)$#s', $pathinfo, $matches)) {
            if ($this->context->getMethod() != 'POST') {
                $allow[] = 'POST';
                goto not_comment_create;
            }

            return $this->mergeDefaults(array_replace($matches, array('_route' => 'comment_create')), array (  '_controller' => 'FrontendBundle\\Controller\\CommentController::createAction',));
        }
        not_comment_create:
